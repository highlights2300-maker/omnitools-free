  ...
  return (
    <StaticPageShell eyebrow="Legal" title="Privacy Policy">
      ...
      <ul className="list-disc space-y-1 pl-5 text-slate-400">
        ...
        <li>We don't run analytics that identify you individually or track you across other websites.</li>
      </ul>
      ...
      <H2>Aggregate, privacy-friendly site analytics</H2>
      <p>
        To understand roughly how many people visit the site and which tools are most used, we use
        Vercel Web Analytics — a privacy-focused analytics service built into our hosting provider. It
        doesn't use cookies, and it doesn't identify you individually: visitors are represented by a
        one-way hash generated from the request, which is discarded within 24 hours and can't be used to
        track you across other websites. We only ever see aggregate numbers — total visits, popular
        pages — never anything tied back to a specific person.
      </p>
      ...
      <H2>Cookies</H2>
      <p>
        QuickZeta does not set its own tracking cookies, and our own site analytics don't use cookies
        either. Cookies you may see in your browser while using this site come from our advertising
        partner (Google) as described above. You can block or delete cookies at any time through your
        browser's settings; doing so will not affect any tool's functionality, since none of them depend
        on cookies to work.
      </p>
